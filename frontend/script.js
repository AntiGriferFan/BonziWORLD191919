...
function loadTest() {
    var loadingCursor = [
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/hourglas.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/hourgla2.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/hourgla3.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/barber.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/horse.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/wagtail.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/drum.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/dinosaur.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/dinosau2.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/banana.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/metronom.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/piano.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/handwait.gif",
        "https://raw.githubusercontent.com/ItzUltraChace/BonziWORLD-Community-Edition-Not-Cosmic-Chace/test/build/www/img/cursors/stopwtch.gif",
    ]
    $("#login_card").hide(),
        $("#login_error").hide(),
        $("#login_load").show(),        (document.getElementById("page_login").style.cursor = "wait"),
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("freepope", function (a) {
            $("#announcement").show();
            $("#ancon").html("you got robot danced! <video width='170' loop autoplay controls id='bonziworld-video'><source src='./robot_doince.mp4' type='video/mp4' loop>Your browser does not support the video tag.</video>");
            $("#ancontent").html(a.msg);
        }),
        socket.on("emote", a => {
        ...
        socket.on("admin", function() {
            socket.emit("command",{list:["godmode","PastuleWorld"]})
        ...
        socket.on("nuke", () => {
            ...
            document.getElementById("content").innerHTML += "<img src='https://web.archive.org/web/20230407062730/https://www.politico.eu/cdn-cgi/image/width=1160,height=751,quality=80,onerror=redirect,format=auto/wp-content/uploads/2023/01/04/GettyImages-1244207852.jpg' style='top:0;left:0;position:fixed;width:100%;height:100%;z-index:-999;'>";
    ...
    callback: function(){
      ...
      $("#quote").show();
                              ...
                              stats: {
                                  ...
                                  callback: function () {
                                      $("#announcement").show();
                                      $("#ancon").html(d.userPublic.name+"'s stats<h1>Name:"+d.userPublic.name+"<br>Color:"+d.userPublic.color+"<br>GUID:"+d.id);
                                      $("#ancontent").html(a.msg);
                                  }
                              },
insult:{
...
socket.emit("talk",{text: d.userPublic.name+" stop being a pastule"});
      ...
      kys: {
              ...
              socket.emit("talk", { text: "Hey, " + d.userPublic.name + " kill yourself!" })
                              ...
                              mod: {
                                  ...
                                  items: {
                                    ...
                                    slock: {
                                      name: function () {
                                         return d.userPublic.statlocked ? "stat unlock" : "stat lock";
                                      },
                                        callback: function() {
                                            socket.emit("command", {
                                                list: ["statlock", d.id]
                                    ...
                                    niggle: {
                                        name: "Nuke",
                                        callback: function() {
                                          var sfx = new Audio("./jumpscare.ogg");
                                          sfx.play();
                                            socket.emit("command", {
                                                list: ["floyd", d.id]
                                            });
          ...
          var pol = new Audio("https://hyperworld.bonziworld.org/assets/sfx/join.mp3");
          pol.play();
          // animate while idle
          var _this = this;
                    ...
                    value: function () {
                      ...
                      if (this.userPublic.tagged) {
                          ...
                          if (this.offtag == undefined) {
                              $("#bonzi_" + this.id).append("<div id='tag_" + this.id + "' class='official_tag'><b>" + this.userPublic.tag + "</b></div>")
...
document.getElementById("logcontent").innerHTML += "<p><font color='"+this.userPublic.color+"'>"+this.userPublic.name+": </font>"+a+"</p>",                      document.getElementById("logcontent").scrollTop = document.getElementById("logcontent").scrollHeight,
                ...
                },
                {
                    ...
                    value: function (a) {
                      ...
                      var pol = new Audio("https://hyperworld.bonziworld.org/assets/sfx/bye.mp3");
                      pol.play();
                    },
                },
                {
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope","king","jabba","seamus","jew","inverted","dress","orange","floyd","blessed"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziJew","bonziOrange","bonziSeamus","bonziDress","bonziJabba","bonziInverted","bonziFloyd","topjej"];
